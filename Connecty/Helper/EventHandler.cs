...
namespace Connecty
{
    ...
    public class TelegrammColorEventArgs : EventArgs
    {
        ...
        /// 1 = Send // 2 = Recive
        /// </summary>
        public int SendReciveSelection { get; set; }
    }

    public delegate void TelegrammColorChangedEventHandler(object sender, TelegrammColorEventArgs e);
